(function() {
    angular.module('manageApp.order').factory('OrderSrvc', OrderSrvc);
    OrderSrvc.$inject = ['$rootScope','$q','$resource','$http','$window','ConfigSrvc','Msg','Utils'];
    function OrderSrvc($rootScope,$q,$resource,$http,$window,ConfigSrvc,Msg,Utils){
    	var service = {
    			getSites:getSites,
    			getSite:getSite,
    			addSite:addSite,
