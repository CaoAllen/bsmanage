package com.spring.example.test.web;
...
import com.spring.example.config.Jackson2ObjectMapperConfig;
import com.spring.example.config.JpaConfig;
import com.spring.example.config.WebConfig;
...
import com.spring.example.test.Fixtures;
